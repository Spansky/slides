...
/********************************************************
* Changes below:                                        *
* Modified original plugin and replaced the static      *
* footer with an iframe that shows dynamic content      *
*                                                       *
* Author: Leon Sczepansky                               *
*                                                       *
* License: GPL v3                                       *
* http://www.gnu.org/copyleft/gpl.html                  *
*                                                       *
********************************************************/
    ...
    var title_footer_iframe=document.createElement('iframe');
    title_footer_iframe.setAttribute('src','http://uhm.codepals.com/small')
    title_footer.appendChild(title_footer_iframe);
